...
CGO_ENABLED=0 GOOS=windows GOARCH=amd64 go build -ldflags="-s -w" -o ./release/aScan_win64 ./main.go
...
CGO_ENABLED=0 GOOS=windows GOARCH=386 go build -ldflags="-s -w" -o ./release/aScan_win32 ./main.go
CGO_ENABLED=0 GOOS=linux GOARCH=arm go build -ldflags="-s -w" -o ./release/aScan_linuxarm
CGO_ENABLED=0 GOOS=windows GOARCH=arm go build -ldflags="-s -w" -o ./release/aScan_winarm ./main.go
